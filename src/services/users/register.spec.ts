...
//     }
//     const { user } = await sut.execute(userMock)
//     const isPasswordCorrectlyHashed = await compare(userMock.password, user.passoword_hash)
...
//     await expect(() => sut.execute(secondUserMock)).rejects.toBeInstanceOf(UserAlreadyExistsError)
//   })
// })
